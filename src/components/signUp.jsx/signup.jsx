...
function SignUp(props) {
    ...
    const [signUpObj, setSignUpObj] = React.useState({ name: '', phone: '', emailID: '', password: '' })
    ...
    const submit = () => {
        ...
        if (emailtest === false) {
            setRegexObj(prevState => ({ ...prevState, emailBorder: true, emailHelper: 'Enter vValid Email ID' }))
        }
    ...
    return (
        <div className="MainSignUpDiv">
            ...
            <div className="EmailBox">
                <TextField id="outlined-basic" error={regexObj.emailBorder} helperText={regexObj.emailHelper} label="Email Id" variant="outlined" style={{ width: '100%' }} size="small" onChange={takePhone} />
            </div>
            <div className="PasswordBox">
                <TextField id="outlined-basic" error={regexObj.passwordBorder} helperText={regexObj.passwordHelper} label="Password" variant="outlined" style={{ width: '100%' }} size="small" onChange={takeEmail} />
            </div>
            <div className="MobileNoBox">
                <TextField id="outlined-basic" error={regexObj.phoneBorder} helperText={regexObj.phoneHelper} label="Mobile Number" variant="outlined" style={{ width: '100%' }} size="small" onChange={takePassword} />
            </div>
